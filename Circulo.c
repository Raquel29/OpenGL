...
void init(void){
	glClearColor(0.5, 0.5, 0.5, 0.5); //Cor de fundo 
...
void display(void){
	...
	glColor3f(0.5, 0.5, 1.0); //cor da linha 

	GLfloat circle_points = 100.0f;
	GLfloat angle, raioX=200.0f, raioY = 200.0f; // Os raios X e Y definem o tamanho da figura
